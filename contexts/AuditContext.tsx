...
interface AuditContextType {
    ...
    loading: boolean;
    error: string | null;
    submitServiceRequest: (serviceType: ServiceType, details: Record<string, any>, parentAuditId?: string) => Promise<ServiceReport | null>;
...
export const AuditProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const submitServiceRequest = useCallback(async (serviceType: ServiceType, details: Record<string, any>, parentAuditId?: string): Promise<ServiceReport | null> => {
        setLoading(true);
        setError(null);
        try {
