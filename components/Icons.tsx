...
export const PaypalIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M8.336 4.345c.236-.344.56-.37.86-.062l2.122 2.122c.23.23.55.23.78 0l2.12-2.123c.3-.306.624-.28.86.062l3.23 4.7c.236.344.135.81-.225 1.01l-2.122 1.22c-.23.13-.505.13-.734 0l-2.12-1.22c-.3-.173-.623-.173-.924 0l-2.12 1.22c-.23.13-.504.13-.735 0l-2.123-1.22c-.36-.2-.46-.666-.225-1.01l3.23-4.7zM15.53 14.22l-2.12 2.12c-.23.23-.55.23-.78 0l-2.12-2.12c-.302-.303-.786-.173-1.01.224l-1.22 2.12c-.2.36-.127.836.173 1.01l4.7 3.23c.344.236.81.135 1.01-.225l1.22-2.123c.23-.398.06-.88-.224-1.01l-2.12-1.22c-.116-.067-.257-.067-.373 0z" />
    </svg>
);

export const CryptoIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <circle cx="12" cy="12" r="10" /><path d="M9 12H15" /><path d="M12 9V15" /><path d="M12 18V22" /><path d="M12 2V6" /><path d="M22 12H18" /><path d="M6 12H2" />
    </svg>
);
